			  	...
			  	<?php
					...
					{ 
 						...
 						echo "<td>".$aux["nome"]."</td>"; 
  						...
  						echo "<td> <a class='btn btn-primary' href='editarAta.php?id=$aux[id_ata]'> <svg xmlns='http://www.w3.org/2000/svg' width='16' height=16' fill='currentColor' class='bi bi-pen-fill' viewBox='0 0 16 16'>
